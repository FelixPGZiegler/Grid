...
public:
  ...
  CloverField CloverTerm;                                       // Clover term
  CloverField ExpCloverTerm, ExpCloverTermInv;                  // ExpClover term
  CloverField ExpCloverTermEven, ExpCloverTermOdd;              // ExpClover term EO
  CloverField ExpCloverTermInvEven, ExpCloverTermInvOdd;        // ExpClover term Inv EO
  CloverField ExpCloverTermDagEven, ExpCloverTermDagOdd;        // ExpClover term Dag EO
  CloverField ExpCloverTermInvDagEven, ExpCloverTermInvDagOdd;  // ExpClover term Inv Dag EO
};
